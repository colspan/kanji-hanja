// Modified by @colspan, to make sorting force at data loading
...
(function() {
  d3.parsets = function() {
      ...
      selection.each(function(data, i) {
        ...
        function updateDimensions() {
          ...
          dimensions.forEach(function(d) {
            d.categories.sort(function(a, b) { return a.name < b.name ? -1 : 1; });// modified;
          });
          /* sorting force end */
        ...
        function updateRibbons() {
          ...
          mouse.enter().append("path")
              ...
              .on("click.parsets", function(d){
                ...
                if(ribbonClicked) ribbonClicked.call(this, d, nodes);
              });
          mouse
    ...
    // 漢字検索用拡張
    parsets.ribbonClicked = function(_) {
      if (!arguments.length) return ribbonClicked;
      ribbonClicked = _ == null ? function(){} : _;
      return parsets;
    };
